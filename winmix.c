                     ...
                     Bool       activating)
{
    ...
    (*s->display->handleCompizEvent) (s->display, "winmix", "activate", o, 2);
}
                ...
                Bool                  showPopup)
{
    ...
    if (otherScreenGrabExist (s, "winmix", "scale", "cube", 0))
        return;
    ...
    if (!ss->grabIndex)
        ss->grabIndex = pushScreenGrab (s, s->invisibleCursor, "winmix");
